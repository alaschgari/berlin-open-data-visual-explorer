...
const translations: Translations = {
    ...
    'desc_noise': { de: 'Strategische Lärmkarten 2022: Verkehrs-, Flug- und Industrielärm tags und nachts.', en: 'Strategic noise maps 2022: traffic, aircraft and industrial noise by day and night.' },
    ...
    'tab_noise': { de: 'Lärm', en: 'Noise' },
    'noise_title': { de: 'Lärmkarten', en: 'Noise Maps' },
    'noise_subtitle': { de: 'Strategische Lärmkarten 2022 nach EU-Umgebungslärmrichtlinie – berechnete Lärmbelastung in dB(A)', en: 'Strategic noise maps 2022 under the EU Environmental Noise Directive – modelled noise levels in dB(A)' },
    'noise_period': { de: 'Zeitraum', en: 'Period' },
    'noise_period_den': { de: 'Ganztags (L DEN)', en: 'Day-evening-night (L DEN)' },
    'noise_period_n': { de: 'Nachts (L N)', en: 'Night (L N)' },
    'noise_source': { de: 'Lärmquelle', en: 'Noise source' },
    'noise_source_total': { de: 'Gesamtverkehr (Straße, Schiene, Luft)', en: 'All traffic (road, rail, air)' },
    'noise_source_road': { de: 'Straßenverkehr', en: 'Road traffic' },
    'noise_source_tram_ubahn': { de: 'Straßenbahn und oberirdische U-Bahn', en: 'Tram and above-ground U-Bahn' },
    'noise_source_air': { de: 'Flugverkehr', en: 'Air traffic' },
    'noise_source_industry': { de: 'Industrieanlagen (Kraftwerke)', en: 'Industrial plants (power stations)' },
    'noise_quiet_areas': { de: 'Ruhige Gebiete 2024 einblenden', en: 'Show quiet areas 2024' },
    'noise_opacity': { de: 'Deckkraft der Lärmkarte', en: 'Noise layer opacity' },
    'noise_legend': { de: 'Legende', en: 'Legend' },
    'noise_hint_den': { de: 'Der Berliner Lärmaktionsplan stuft ganztägige Pegel über {db} dB(A) als gesundheitsgefährdend ein.', en: 'The Berlin noise action plan considers day-evening-night levels above {db} dB(A) harmful to health.' },
    'noise_hint_n': { de: 'Der Berliner Lärmaktionsplan stuft nächtliche Pegel über {db} dB(A) als gesundheitsgefährdend ein.', en: 'The Berlin noise action plan considers night levels above {db} dB(A) harmful to health.' },
    'noise_source_note': { de: 'Quelle: Umweltatlas Berlin, Senatsverwaltung für Mobilität, Verkehr, Klimaschutz und Umwelt – gdi.berlin.de', en: 'Source: Berlin Environmental Atlas, Senate Department for the Environment – gdi.berlin.de' },
