...
const translations: Translations = {
    ...
    'desc_air_quality': { de: 'Live-Luftqualitätsindex und Schadstoffwerte der Berliner Messstationen.', en: 'Live air quality index and pollutant levels from Berlin monitoring stations.' },
    ...
    'tab_air_quality': { de: 'Luftqualität', en: 'Air Quality' },
    'air_title': { de: 'Luftqualität live', en: 'Live Air Quality' },
    'air_subtitle': { de: 'Luftqualitätsindex der Stationen des Berliner Luftgütemessnetzes (BLUME), stündlich aktualisiert', en: 'Air quality index from the Berlin air quality monitoring network (BLUME), updated hourly' },
    'air_measured_at': { de: 'Stand:', en: 'As of:' },
    'air_stations': { de: 'Stationen mit Index', en: 'Stations reporting' },
    'air_average': { de: 'Ø Index', en: 'Avg. index' },
    'air_worst': { de: 'Höchster Index', en: 'Highest index' },
    'air_category_all': { de: 'Alle', en: 'All' },
    'air_category_traffic': { de: 'Verkehr', en: 'Traffic' },
    'air_category_background': { de: 'Stadt', en: 'Urban' },
    'air_category_suburb': { de: 'Stadtrand', en: 'Suburban' },
    'air_category_other': { de: 'Sonstige', en: 'Other' },
    'air_lqi_1': { de: 'Sehr gut', en: 'Very good' },
    'air_lqi_2': { de: 'Gut', en: 'Good' },
    'air_lqi_3': { de: 'Befriedigend', en: 'Moderate' },
    'air_lqi_4': { de: 'Ausreichend', en: 'Sufficient' },
    'air_lqi_5': { de: 'Schlecht', en: 'Poor' },
    'air_lqi_6': { de: 'Sehr schlecht', en: 'Very poor' },
    'air_no_index': { de: 'Kein aktueller Index', en: 'No current index' },
    'air_index': { de: 'Luftqualitätsindex', en: 'Air quality index' },
    'air_last_hours': { de: 'Letzte Stunden', en: 'Last hours' },
    'air_no_series': { de: 'Keine Messwerte verfügbar', en: 'No measurements available' },
    'air_unit_hint': { de: 'Stundenmittelwerte in µg/m³', en: 'Hourly means in µg/m³' },
    'air_ranking': { de: 'Stationen nach Index', en: 'Stations by index' },
    'air_select_hint': { de: 'Wähle eine Station für Details und Verlauf.', en: 'Select a station for details and history.' },
    'air_close': { de: 'Schließen', en: 'Close' },
    'air_error': { de: 'Luftqualitätsdaten konnten nicht geladen werden.', en: 'Air quality data could not be loaded.' },
    'air_source': { de: 'Quelle: Senatsverwaltung für Mobilität, Verkehr, Klimaschutz und Umwelt – luftdaten.berlin.de', en: 'Source: Berlin Senate Department for the Environment – luftdaten.berlin.de' }
};
