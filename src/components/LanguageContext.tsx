...
const translations: Translations = {
    ...
    'biz_show_hits_limit': { de: 'Zeige die ersten 500 von {count} Treffern • Benutze die Suche zum Eingrenzen', en: 'Showing first 500 of {count} hits • Use search to narrow down' },
